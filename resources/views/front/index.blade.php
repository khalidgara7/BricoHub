                ...
                @foreach ($services as $service)
                    <div class="blog-item">
                        <img src="{{ asset('storage/images/services/' . $service->image) }}"
                            class="img-fluid w-100 rounded-top" alt="" style="width: 100px; height: 200px;">
                        <div class="rounded-bottom bg-light">
                            <div class="d-flex justify-content-between p-4 pb-2">
                                <span class="pe-2 text-dark"><i class="fa fa-user me-2"></i>
                                    {{ $service->employee->name }} </span>
                                <span class="text-dark"><i
                                        class="fas fa-calendar-alt me-2"></i>{{ $service->created_at->format('Y-m-d') }}</span>
                            </div>
                            <div class="px-4 pb-0">
                                <h4>{{ $service->title }}</h4>
                            ...
                            <div class="p-4 py-2 d-flex justify-content-between bg-primary rounded-bottom blog-btn">
                                <a href="{{ route('list-services') }}" type="button" class="btn btn-primary border-0">
                                    View </a>
                                <a href="#" class="my-auto btn-primary border-0"><i
                                        class="fa fa-comments me-2"></i>23
                                    Comments</a>
                            </div>
                        </div>
                    </div>
