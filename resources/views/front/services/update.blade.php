                                    ...
                                    <div class="col-md-12 col-xl-10">
                                        ...
                                        <form action="{{route('service.update',$service)}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col">
                                                    <div data-mdb-input-init class="form-outline">
                                                        ...
                                                        <input name="title" value="{{$service->title}}" type="text" id="form6Example1" class="form-control" />
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div data-mdb-input-init class="form-outline">
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <textarea  name="description" id="form6Example3" class="form-control" id="" cols="10" rows="8">{{$service->description}}</textarea>
                                            </div>
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <input name="years_of_experience" value="{{$service->years_of_experience}}" type="number" id="form6Example5" class="form-control" min="0" max="20" />
                                            </div>                                            
                                            ...
                                            <div data-mdb-input-init class="form-outline mb-4">
                                                ...
                                                <div class="input-group">
                                                    <input name="price" value="{{$service->price}}" type="number" id="form6Example6" class="form-control" />
